...
export const authProvider: AuthProvider = {
    login: async ({ email }) => {
        try {
            ...
            //this will call dataProvider which willgo through the fetchWrapper function
    ...
    //simply remove the accessToken from the localStorage for the logout
    logout: async () => {
    ...
    onError: async (error) => {
        //a check to see if the error is the authentication error
    ...
    check: async () => {
        try {
            ...
            //this is to know if the user is autenticated or not
    ...
    getIdentity: async () => {
        ...
        try {
            ...
            //we are using me:any because the graphql api doesnt have a type for the me query yet
            //we will add some queries and mutations later and change this user
